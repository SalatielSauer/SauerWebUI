...
[Download SauerWebUI (28-06-2025) ZIP](https://github.com/SalatielSauer/SauerWebUI/releases/download/v0.2-test/sauerwebui_jsquare_02-07-2025.zip)

[Download SauerWebUI (28-06-2025) installer](https://github.com/SalatielSauer/SauerWebUI/releases/download/v0.2-test/sauerwebui_jsquare_02-07-2025_installer.exe)
...
- ### `writeobjuvmap <name> <dump lightmap texture 1/0>`
	Exports a map as an .obj file containing lightmap coordinates. You can then use Blender to import the obj file with UV coordinates.
